...
# **0. 팀원 소개 및 역할**
> 백엔드 담당 : 조민준  이메일 : simpers@naver.com [깃허브링크](https://github.com/Jominjun1/FoodfixProject/blob/backend)

> 프론트엔드(React) : 김규리 이메일 : [깃허브링크](https://github.com/Jominjun1/FoodfixProject/blob/frontend_web)

> 프론트엔드(IOS) : 노현민 이메일 : [깃허브링크](https://github.com/Jominjun1/FoodfixProject/blob/frontend_ios)

> 프론트엔드(Android) : 최명진 이메일 : [깃허브링크](https://github.com/Jominjun1/FoodfixProject/blob/frontend_android)
